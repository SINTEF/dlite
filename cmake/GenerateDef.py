...
class DoxyXML:
    ...
    def get_from_file(self, filename, kind=None):
        ...
        for compound in self.dom.getElementsByTagName("compound"):
            if (
                compound.getAttribute("kind") == "file"
                and gettext(compound.firstChild) == filename
            ):
    ...
    def generate_deffile(self, library, sources, deffile=None):
        ...
        defs = "\n".join(["LIBRARY " + os.path.basename(library), "EXPORTS"] + exports)
...
def main():
    ...
    parser.add_argument("library", help="Name of library to generate .def file for.")
    parser.add_argument("xmlfile", help="Doxygen-generated index.xml file.")
    parser.add_argument("sources", nargs="+", help="Source files, typically .c files.")
    parser.add_argument(
        "--output",
        "-o",
