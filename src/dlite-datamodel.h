...
/**
  ...
  an entity.  You normally not call the functions defined in this
  header file if you access data via the interface generated by the
  dlite code generator.

  Data models are initialised with dlite_datamodel_init() and cleaned
  up with dlite_datamodel_clear().  To reduce memory allocations,
  these functions are passed a pointer to a DLiteDataModel that typically
  reside on the stack.
*/
