    ...
    def write_output(self):
        ...
        for module in self.filesmap:
            ...
            if module in self.dirsmap:
                innerdirs = [
                    (os.path.basename(module) + "/" + os.path.basename(innerdir))
            ...
            innerfiles = [
                basename + "/" + os.path.basename(innerfile.rsplit(".", 1)[0])
            ...
            buffer = toc_template.render(
                title=basename, refs=list(innerfiles) + innerdirs
            )
