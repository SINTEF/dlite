...
coll1 = dlite.Collection.load("json", outdir / "coll1.json", "mode=r", id=coll.uuid)
...
assert list(coll.get_predicates()) == ["is-a", "_is-a", "_has-uuid", "_has-meta"]
assert list(coll.get_objects()) == ["animal", "Instance", inst1.uuid, inst1.meta.uri]
