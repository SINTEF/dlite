...
typedef struct _Chemistry {
  ...
  char **elements;               /*!< Chemical symbol of each chemical element.  By convension the dependent element (e.g. Al) is listed first. [nelements] */
  char **phases;                 /*!< Name of each phase. [nphases] */
  float64_t *X0;                 /*!< Nominal composition.  Should sum to one. [nelements] */
  float64_t *Xp;                 /*!< Average composition of each phase, excluding matrix.  Each row should sum to one. [nphases,nelements] */
  float64_t *volfrac;            /*!< Volume fraction of each phase, excluding matrix. [nphases] */
  float64_t *rpart;              /*!< Average particle radius of each phase, excluding matrix. [nphases] */
  float64_t *atvol;              /*!< Average volume per atom for each phase. [nphases] */
